 ...
 * 
 * @property ms - The maximum number of milliseconds to wait for the function to complete. Defaults to 0.
 * @property waitPromise - Whether to wait for a Promise returned by the function to resolve before resolving the Promise. Defaults to true.
 */
