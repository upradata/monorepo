...
// I had to copy/past webpack/type.d.ts and change all declare with export because none of webpack internals have been exported!!!!
...
import { Stats as FsStats, WriteStream } from 'node:fs';
...
export interface ArgumentConfig {
    ...
    path: string;
    multiple: boolean;
    type: 'string' | 'number' | 'boolean' | 'node:path' | 'enum' | 'RegExp' | 'reset';
    values?: any[];
}
...
export abstract class AsyncDependenciesBlock extends DependenciesBlock {
    groupOptions: {
        preloadOrder?: number;
...
export abstract class ByTypeGenerator extends Generator {
    map: any;
}
export const CIRCULAR_CONNECTION: unique symbol;
export class Cache {
    constructor();
    hooks: {
...
export abstract class CacheFacade {
...
export interface CallbackNormalErrorCache<T> {
...
export class ChunkPrefetchPreloadPlugin {
    constructor();
    apply(compiler: Compiler): void;
}
...
export abstract class CodeGenerationResults {
...
export interface ConcatenatedModuleInfo {
    index: number;
    module: Module;
...
export interface ConcatenationBailoutReasonContext {
    /**
     * the module graph
     */
    moduleGraph: ModuleGraph;
...
export class ConcatenationScope {
    constructor(
        modulesMap:
...
export abstract class ContextElementDependency extends ModuleDependency {
...
export abstract class ContextModuleFactory extends ModuleFactory {
    hooks: Readonly<{
...
export class DeterministicChunkIdsPlugin {
    constructor(options?: any);
    options: any;
...
type DllReferencePluginOptionsSourceType =
    ...
    | 'jsonp'
    | 'system';
export class DynamicEntryPlugin {
...
export class ElectronTargetPlugin {
...
export class EnableChunkLoadingPlugin {
...
export abstract class EntryDependency extends ModuleDependency { }
...
export abstract class Entrypoint extends ChunkGroup {
    /**
...
export interface FakeHookMarker { }
...
export class FetchCompileAsyncWasmPlugin {
    constructor();
...
export interface FileSystemCallback<T> {
...
export class GetChunkFilenameRuntimeModule extends RuntimeModule {
    constructor(
        contentType: string,
        name: string,
        global: string,
...
export interface GroupConfig<T, R> {
...
export abstract class HelperRuntimeModule extends RuntimeModule { }
...
export class HotUpdateChunk extends Chunk {
    constructor();
}
export class HttpUriPlugin {
    constructor();
...
export abstract class ItemCacheFacade {
...
export class JsonpChunkLoadingRuntimeModule extends RuntimeModule {
...
export interface LoadScriptCompilationHooks {
    createScript: SyncWaterfallHook<[ string, Chunk ]>;
}
export class LoadScriptRuntimeModule extends HelperRuntimeModule {
    constructor();
    static getCompilationHooks(
        compilation: Compilation
...
export abstract class ModuleDependency extends Dependency {
    request: string;
    userRequest: string;
    range: any;
}
...
export abstract class NormalModuleFactory extends ModuleFactory {
    hooks: Readonly<{
...
export interface PnpApiImpl {
    resolveToUnqualified: (arg0: string, arg1: string, arg2?: any) => string;
}
export interface PossibleFileSystemError {
    code?: string;
    errno?: number;
    path?: string;
    syscall?: string;
...
export interface RenderManifestEntryStatic {
    render: () => Source;
    filename: string;
    info: AssetInfo;
    identifier: string;
...
export interface RenderManifestEntryTemplated {
    render: () => Source;
    filenameTemplate: string | ((arg0: PathData, arg1: AssetInfo) => string);
...
export interface ResolveOptionsTypes {
    alias: {
        /**
         * New request.
         */
...
export class RuntimeModule extends Module {
...
export abstract class RuntimeSpecMap<T> {
...
export abstract class RuntimeSpecSet {
...
export const TRANSITIVE_ONLY: unique symbol;
...
export interface TimestampAndHash {
    safeTime: number;
    timestamp?: number;
    timestampHash?: string;
    hash: string;
...
export interface UpdateHashContextDependency {
    chunkGraph: ChunkGraph;
    runtime: string | SortableSet<string>;
    runtimeTemplate?: RuntimeTemplate;
}
export interface UpdateHashContextGenerator {
    /**
     * the module
     */
    module: NormalModule;
...
export class WebpackOptionsApply extends OptionsApply {
    constructor();
}
